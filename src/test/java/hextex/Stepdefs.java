...
public class Stepdefs {
    ...
    @When("^title \"([^\"]*)\" and author \"([^\"]*)\" and year \"([^\"]*)\" and publisher \"([^\"]*)\" and reference \"([^\"]*)\" are given$")
    public void fields_entered(String title, String author, String year, String publisher, String reference) throws Throwable {
        inputLines.add(title);
        inputLines.add(author);
        inputLines.add(year);
        inputLines.add(publisher);
        inputLines.add(reference);
    ...
    public void new_book_created() throws Throwable {
        ...
        assertEquals(dao.getReferences().get(0).getName(), "kirja");
    }
