...
public class Stepdefs {
    ...
    public void inproceedings_is_selected() throws Throwable {
    ...
    @When("^journal \"([^\"]*)\" is entered$")
    public void journal_is_entered(String journal) throws Throwable {
        inputLines.add(journal);

    }@When("^volume \"([^\"]*)\" is entered$")
    public void volume_is_entered(String volume) throws Throwable {
        inputLines.add(volume);

    }
    
    @When("^pages \"([^\"]*)\" is entered$")
    public void pages_is_entered(String pages) throws Throwable {
        inputLines.add(pages);

    }

//    @When("^unproper author \"([^\"]*)\" is entered$")
//    public void unproper_author_is_entered(String author) throws Throwable {
//        inputLines.add(author);
//        inputLines.add("Toimiva Nimi");
...
//    }
    ...
    @And("^bookTitle \"([^\"]*)\" is entered$")
    public void bookTitle_is_entered(String title) throws Throwable {
        inputLines.add(title);
    ...
    public void new_article_created() throws Throwable {
        assertTrue(io.getPrints().contains("Article was succesfully created!"));
    }
     @Then("^a new inproceedings is created$")
    public void new_inproceedings_created() throws Throwable {
        assertTrue(io.getPrints().contains("Inproceedings was succesfully created!"));
    }
